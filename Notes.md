* git diff
show the recent changes before the files are moved to staging area.
* git diff --cached
show the recent changes after the files are moved to staging area.
* git does not track empty folders.
* how to tell git to keep track of empty folders. Add a file .gitkeep inside that empty folder
* git log - shows all the commits
* git log -p -> shows commits as well as the changes in each commit
* git show <commit-id> - shows the changes in that commit
